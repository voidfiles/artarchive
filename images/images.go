...
func (iu *ImageUploader) Archive(metadata map[string]*string, imageURL string) (*slides.ImageInfo, error) {
...
func NewSlideImageUploader(iu *ImageUploader) *SlideImageUploader {
	return &SlideImageUploader{
		iu: iu,
	}
}

func (sc *SlideImageUploader) Configure(binding slides.Binding) {
	sc.binding = binding
}
